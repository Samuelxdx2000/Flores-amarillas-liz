...
<!-- DEDICA:META -->
<title>Para ti liz 💖</title>
<meta name="description" content="Una galaxia sencilla con agujero negro, anillo dorado y fotos flotando entre frases del Día de las Flores Amarillas.">
...
const DEFAULTS = {
  ...
  frases: [
    "🌻Estas flores son para ti, Liz","🌼Un pequeño detalle para una gran persona","🌻Porque tú también mereces flores ",
    "🌼Para alegrarte un poquito el día, Liz","🌻 Un detallito hecho con cariño para ti","🌼Espero que esto te saque una sonrisa",
    "🌻Una flor para alguien que vale mucho","🌼Gracias por ser una bonita amistad",
    "🌻Para una personita que se ganó mi aprecio",
    "🌼Espero que este detalle te guste mucho","🌻 Qué bonito coincidir contigo",
    "🌼Que este pequeño detalle te alegre",
    "🌻 Te quiero","🌼Tienes un lugar muy bonito en mi ❤️","🌻 I LOVE YOU",
    "🌼 TQM","🌻 Me alegras los dias","🌼 Un ramo de gracias por estar ahí",
    "🌻 Que esta flor te alcance hoy","🌼 I LOVE YOU","🌻Te tengo un cariño enorme, Liz.",
    "🌼 Tu cariño no pasa de moda","🌻 Eres una gran persona","🌼 Esta flor es para ti",
    "🌻Eres alguien a quien quiero muchísimo","🌼 Quiero que sepas cuánto importas",
    "🌻Espero mas momentos contigo",
    "🌼TQM","🌻 Aquí siempre estare","🌼 Feliz dia vv"
  ],
